...
alias com {
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/altera_avalon_sc_fifo.v"                        
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SlowPll_sim/SlowPll.vo"                                     
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpm_pll_sim/lpm_pll.vo"                                     
}
