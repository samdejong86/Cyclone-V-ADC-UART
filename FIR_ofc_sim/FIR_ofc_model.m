...
% ================================================================================
% Generated on: 02/28/2018 10:14:10
...
for j = 1:sx
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = FIR_ofc_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['FIR_ofc_model_output'];
