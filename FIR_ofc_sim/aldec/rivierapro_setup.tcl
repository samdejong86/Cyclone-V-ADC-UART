...
# ACDS 16.1 196 linux 2018.02.28.10:14:11
# ----------------------------------------
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_rtl_core.vhd"                           
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_ast.vhd"                                
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc.vhd"                                    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_tb.vhd"                                 
}
