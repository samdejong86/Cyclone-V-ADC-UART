...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/dspba_library_package.vhd"                      
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/dspba_library.vhd"                              
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_math_pkg_hpfir.vhd"                   
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_lib_pkg_hpfir.vhd"                    
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_controller_hpfir.vhd"
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_sink_hpfir.vhd"      
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_source_hpfir.vhd"    
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_roundsat_hpfir.vhd"                   
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/FIR_ofc_sim/altera_avalon_sc_fifo.v"                        
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_rtl_core.vhd"                           
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_ast.vhd"                                
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc.vhd"                                    
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_tb.vhd"                                 
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/SlowPll_sim/SlowPll.vo"                                     
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/lpm_pll_sim/lpm_pll.vo"                                     
fi
