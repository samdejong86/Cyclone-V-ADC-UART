...
# ----------------------------------------
# If FIR_MovingAverage is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 linux 2017.10.20.12:34:07
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FIR_MovingAverage"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_MovingAverage_rtl_core.vhd"                 
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_MovingAverage_ast.vhd"                      
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_MovingAverage.vhd"                          
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_MovingAverage_tb.vhd"                       
}
