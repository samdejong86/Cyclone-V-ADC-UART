...
% ================================================================================
% Generated on: 10/20/2017 12:34:06
...
for j = 1:sx
    ...
    %
    file_name = ['FIR_MovingAverage_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = FIR_MovingAverage_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['FIR_MovingAverage_model_output'];
