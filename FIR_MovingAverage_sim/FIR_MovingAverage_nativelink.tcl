...
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.FIR_MovingAverage_tb -section_id tb
...
if {[file exists $file_dir/FIR_MovingAverage_coef_reload.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/FIR_MovingAverage_coef_reload.txt -section_id tb -library work
}
if {[file exists $file_dir/FIR_MovingAverage_coef_reload_rtl.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/FIR_MovingAverage_coef_reload_rtl.txt -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/FIR_MovingAverage_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/FIR_MovingAverage_tb.vhd -section_id tb -library work
