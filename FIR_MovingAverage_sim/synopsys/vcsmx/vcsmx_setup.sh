...
TOP_LEVEL_NAME="FIR_MovingAverage"
QSYS_SIMDIR="./../../"
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_MovingAverage_rtl_core.vhd"                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_MovingAverage_ast.vhd"                      
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_MovingAverage.vhd"                          
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_MovingAverage_tb.vhd"                       
fi
