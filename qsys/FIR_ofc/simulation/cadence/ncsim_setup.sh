...
TOP_LEVEL_NAME="FIR_ofc"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/srdejong/intelFPGA/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FIR_ofc_fir_compiler_ii_0_rtl_core.vhd"          -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FIR_ofc_fir_compiler_ii_0_ast.vhd"               -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FIR_ofc_fir_compiler_ii_0.vhd"                   -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FIR_ofc_fir_compiler_ii_0_tb.vhd"                -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc.vhd"                                                                                                                    
fi
