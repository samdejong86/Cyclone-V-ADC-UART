...
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.FIR_ofc_fir_compiler_ii_0_tb -section_id tb
...
if {[file exists $file_dir/FIR_ofc_fir_compiler_ii_0_coef_reload.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/FIR_ofc_fir_compiler_ii_0_coef_reload.txt -section_id tb -library work
}
if {[file exists $file_dir/FIR_ofc_fir_compiler_ii_0_coef_reload_rtl.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/FIR_ofc_fir_compiler_ii_0_coef_reload_rtl.txt -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/FIR_ofc_fir_compiler_ii_0_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE $file_dir/FIR_ofc_fir_compiler_ii_0_tb.vhd -section_id tb -library work
