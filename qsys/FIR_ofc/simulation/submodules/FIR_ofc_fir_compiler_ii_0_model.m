...
% ================================================================================
% Generated on: 07/24/2018 10:37:00
...
for j = 1:sx
    ...
    %
    file_name = ['FIR_ofc_fir_compiler_ii_0_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = FIR_ofc_fir_compiler_ii_0_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['FIR_ofc_fir_compiler_ii_0_model_output'];
