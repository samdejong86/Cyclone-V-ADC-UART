...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/lpm_pll_pll_0.vho" -work pll_0 -cdslib ./cds_libs/pll_0.cds.lib
