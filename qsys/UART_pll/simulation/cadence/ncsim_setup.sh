...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/UART_pll_UART_pll.vho" -work UART_pll -cdslib ./cds_libs/UART_pll.cds.lib
