...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/dspba_library_package.vhd"                      
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/dspba_library.vhd"                              
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_math_pkg_hpfir.vhd"                   
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_lib_pkg_hpfir.vhd"                    
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_controller_hpfir.vhd"
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_sink_hpfir.vhd"      
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_source_hpfir.vhd"    
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_roundsat_hpfir.vhd"                   
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/FIR_ofc_sim/altera_avalon_sc_fifo.v"                        
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_rtl_core.vhd"                           
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_ast.vhd"                                
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc.vhd"                                    
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_tb.vhd"                                 
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/SlowPll_sim/SlowPll.vo"                                     
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/lpm_pll_sim/lpm_pll.vo"                                     
fi
