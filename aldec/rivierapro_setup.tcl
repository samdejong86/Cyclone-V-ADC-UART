...
# ACDS 16.1 196 linux 2018.03.19.14:20:25
# ----------------------------------------
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/altera/16.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/dspba_library_package.vhd"                      
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/dspba_library.vhd"                              
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_math_pkg_hpfir.vhd"                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_lib_pkg_hpfir.vhd"                    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_controller_hpfir.vhd"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_sink_hpfir.vhd"      
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_avalon_streaming_source_hpfir.vhd"    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/auk_dspip_roundsat_hpfir.vhd"                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_ofc_sim/altera_avalon_sc_fifo.v"                        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_rtl_core.vhd"                           
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_ast.vhd"                                
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc.vhd"                                    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_ofc_sim/FIR_ofc_tb.vhd"                                 
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SlowPll_sim/SlowPll.vo"                                     
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/lpm_pll_sim/lpm_pll.vo"                                     
}
